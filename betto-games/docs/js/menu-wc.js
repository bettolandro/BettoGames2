...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">betto-games documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            <li class="link">
                                <a href="components/AdminProducts.html" data-type="entity-link" >AdminProducts</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/Catalog.html" data-type="entity-link" >Catalog</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/ProductCard.html" data-type="entity-link" >ProductCard</a>
                            </li>
                            <li class="link">
                                <a href="components/ProductDetail.html" data-type="entity-link" >ProductDetail</a>
                            </li>
                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/CartItemDetail.html" data-type="entity-link" >CartItemDetail</a>
                            </li>
                            <li class="link">
